...
export default function DayView({ listing }: DayViewProps) {
	...
	return (
		<section className='h-full w-full'>
			<div className="h-12 mb-5 px-8 justify-start items-center gap-4 inline-flex">
			...
			{Object.values(listing.days[selectDay]).map((day, i) => (
				<div key={i} className='flex h-[160px] gap-4 m-4'>
					<div className="h-full">
						<p>{day.time}</p>
						<div className="border-l border-dashed border-gray-200 w-[1px] h-[140px] m-auto"></div>
					</div>
					<div className="h-[148px] p-2 bg-black/20 rounded-xl shadow-[4px_8px_16px_0px_rgba(0,0,0,0.25)] border-2 border-[#fedb25] backdrop-blur-xl justify-start items-center gap-4 inline-flex">
						<div className="grow shrink basis-0 self-stretch p-2 flex-col justify-between items-start inline-flex">
							<div className="self-stretch justify-between items-center inline-flex">
								<div className="justify-center items-center gap-2 flex">
									<div className="text-white text-base font-bold leading-normal">{day.name}</div>
								</div>
								...
								<div className="justify-center items-start gap-12 flex">
									<div className="w-64 self-stretch pl-3 pr-4 py-3 bg-black/50 rounded-lg flex-col justify-center items-start gap-1 inline-flex">
										...
										<div className="justify-center items-end gap-2 inline-flex">
											...
											<div className="text-[#f7f7f7] text-sm leading-tight">Denver International Airport</div>
										</div>
									</div>
									...
									<div className="flex-col justify-start items-start gap-2 inline-flex">
										...
										<div className="justify-start items-start gap-0.5 inline-flex">
											<div className="text-[#bbd3fb] font-bold leading-tight">Add</div>
											<div className="w-5 h-5 relative  overflow-hidden" />
										</div>
									</div>
								</div>
								<div className="flex-col justify-center items-end gap-0.5 inline-flex">
									<div className="text-[#f7f7f7] text-base font-bold leading-normal">$0.00</div>
									<div className="text-[#b3b3b3] text-xs font-normal leading-none">per person</div>
								</div>
							</div>
						</div>
					</div>
