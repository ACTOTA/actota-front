        ...
        <GlassPanel className='!p-4 !rounded-[22px]  hover:cursor-pointer flex flex-col gap-2 mt-4 bg-gradient-to-br from-[#6B6B6B]/30 to-[black]'>
            ...
            <div className='flex justify-between items-center'>
                <div className='flex items-center gap-2'>
                    ...
                    {bookingConfirmedModal && <p className='text-sm text-primary-gray flex items-center gap-1'>
                        <Image src="/svg-icons/airplane.svg" alt="points" width={20} height={20} />
                        Booking no. <span className='text-white'>{dataItinerary?._id ? (dataItinerary?._id as { $oid: string }).$oid : 'Loading...'}</span>
                    </p>}
                </div>
            ...
            <div className='flex justify-between relative gap-4 h-full w-full'>
                <div className='w-full'>
                    <div className='flex justify-between items-center text-white'>
                        <p className='text-2xl font-bold'>{dataItinerary?.trip_name || 'Adventure Trip'}</p>
